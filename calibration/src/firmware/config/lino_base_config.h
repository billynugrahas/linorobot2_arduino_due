...
#define COUNTS_PER_REV1 3340                // wheel1 encoder's no of ticks per rev
#define COUNTS_PER_REV2 3340                // wheel2 encoder's no of ticks per rev
#define COUNTS_PER_REV3 3340                // wheel3 encoder's no of ticks per rev
#define COUNTS_PER_REV4 3340                // wheel4 encoder's no of ticks per rev
#define WHEEL_DIAMETER 0.065                // wheel's diameter in meters
#define LR_WHEELS_DISTANCE 0.184            // distance between left and right wheels
